...
<body>
	<div id="main">
		...
		<div id="rightbar">
			...
			<div class="barcrumb">
				<h3>Links</h3>
				Forum: <a href="http://groups.google.com/group/server2go-user" target="_blank">Forum</a><br />
				Wiki: <a href="https://bitbucket.org/thaberkern/server2go/wiki/" target="_blank">Dokumentation &amp; Tutorials</a>
			</div>
		</div>
		<div id="footer">
